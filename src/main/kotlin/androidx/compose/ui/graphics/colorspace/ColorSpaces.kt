...
object ColorSpaces {
    ...
    val Srgb = Rgb(
        ...
        function = SrgbTransferParameters,
        id = 0
    )
    ...
    val ExtendedSrgb = Rgb(
        ...
        primaries = SrgbPrimaries,
        whitePoint = Illuminant.D65, transform = null,
        oetf = { x ->
            absRcpResponse(
                x,
                1 / 1.055,
        ...
        min = -0.799f, max = 2.399f, transferParameters = SrgbTransferParameters,
        id = 2
    )
    ...
    internal val Unspecified = Rgb(
        ...
        primaries = SrgbPrimaries,
        whitePoint = Illuminant.D65,
        function = NoneTransferParameters,
        id = 16
    )
    ...
    fun match(
        ...
        for (colorSpace in ColorSpacesArray) {
            if (colorSpace.model == ColorModel.Rgb) {
                ...
                if (compare(toXYZD50, rgb.transform) && compare(function, rgb.transferParameters)) {
                    return colorSpace
                }
            }
        }
